...
public class Constants {
	...
	public static final String DB2_VALIDATION_QUERY = "SELECT CURRENT_TIMESTAMP FROM SYSIBM.SYSDUMMY1";
	public static final String DB2_WHOAMI_QUERY     = "SELECT CURRENT_USER FROM SYSIBM.SYSDUMMY1";
