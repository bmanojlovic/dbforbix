...
public final class Sender implements Runnable {
    private static final Logger log = Logger.getLogger(Constants.PROJECT_NAME);
...
*/
    ...
    private void send(final String key, final String value) throws IOException {
        ...
        if (log.isDebugEnabled()) {
        	SmartLogger.logThis(Level.TRACE,"sending " + message);
        }
        ...
        while (serverlist.hasMoreElements()){
	        ...
	        try {
	            ...
	            if (log.isDebugEnabled()) {
					SmartLogger.logThis(Level.TRACE, "received "
							+ new String(response));
	            }
